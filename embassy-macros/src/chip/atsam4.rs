...
pub fn generate(args: Args) -> TokenStream {
    ...
    quote!(
        use embassy_atsam4::{rtc, interrupt, Peripherals, pac, hal::rcc::RccExt, hal::time::U32Ext};
        ...
        let rtt = RealTimeTimer::new();
        let mut rtc = rtc::RTC::new(rtt, interrupt::take!(RTT), clocks);
